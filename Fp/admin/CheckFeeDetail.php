...
<body>
    ...
    <div class="sidebar">
     ...
     <div class="enterFeeAmount">



    
           <form action="CheckFeeDetailObj.php" method="POST"> 
               Student name:<input type="text" name="studentName" placeholder="enter student name" class="form-control" required>
                Class:<input type="number" name="studentClass" placeholder="enter student name" class="form-control">
                       <input type="submit" value="check" name="checkFeeDetail" class="btn btn-success"> 
