...
<body>
    ...
    <div class="sidebar">
     ...
     <form action="AddExamObj.php" method="POST">
         <div class="container addExam">
             <h3 style="color:brown;font-family:cursive">Add new Exam</h3><br>
             <div class="row">
                 <div class="col-3">
                 <input type="text" name="addExamCode" placeholder=" exam code" class="form-control"><br>
                 <input type="text" name="addExamName" placeholder=" exam name" class="form-control"><br>
